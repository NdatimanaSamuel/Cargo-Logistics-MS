...
<section class="pcoded-main-container">
                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <div class="page-header-title">
                            <h5 class="m-b-10">Cargo Abonement</h5>
                        </div>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="index.html"><i class="feather icon-home"></i></a></li>
                            <li class="breadcrumb-item"><a href="#!">All Car Cargo Abonement</a></li>
  ...
  <!--           <div class="col-md-6">
            ...
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-header">
                        <h5>View All Car Cargo Abonement</h5>
                    ...
                    <div class="card-body table-border-style">
                        <div class="table-responsive">
                         ...
                         $conn=mysqli_connect("localhost","root","", "cargologisticdb") or die(mysql_error());
                          $no=0;
                         $query = $conn->query("SELECT * FROM `abonement` ORDER BY abonementid DESC") or die(mysqli_error());
                                        ...
                                        <td><?php echo $fetch['driverphone']?></td>
                                          <td><?php echo $fetch['driverotherphon']?></td>
                                           <td>Abonement</td>
                                             ...
                                             <td><?php echo $fetch['remainday']?></td>
                                             <td><?php echo $fetch['doneon']?></td>
                                                <td>
  	

                         <a title="Details Car Cargo" href="detailsCarStatusCargoAbonement.php?id=<?php echo $fetch['abonementid']?>"  class="btn btn-success btn-sm btn-icon-text mr-3">  Details  <i class="typcn typcn-edit btn-icon-append"></i></a>
