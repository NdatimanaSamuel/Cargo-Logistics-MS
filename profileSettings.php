...
require ("updateProfileSettingsQuery.php");
?> 
<!DOCTYPE html>
<html lang="en">
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h5>Update Exist Account Information</h5>
                    </div>  
                     <p class="error palceaddedsuccess-error" style="color:green;background-color: #d2ffd2;">
                                                      <!-- error message -->
                       <?php echo $placeAddedSuccess;?>
                       </p>
                    <?php
                                     ...
                                     $query = $conn->query("SELECT * FROM `admintb` WHERE `adminid` ='".$_SESSION['adminid']."'") or die(mysqli_error());
                                     $fetch = $query->fetch_array();
                                      ?>
                    <div class="card-body">
                        <form method="POST">
                            <div class="row">
                            	  <input type="hidden" name="managerId" value="<?php echo $fetch['adminid']?>"class="form-control" />

                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label class="floating-label" for="Text">Manager Names</label>
                                        <input type="text" class="form-control" name="namess" id="Text" value="<?php echo $fetch['adminname']?>" placeholder="Manager Names" value="" required="">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label class="floating-label" for="Text">Manager Email</label>
                                        <input type="text" class="form-control" name="emailuser" id="Text" value="<?php echo $fetch['adminemail']?>" placeholder="Manager Email" required="">
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="password" name="passw" class="form-control" id="Email" value="<?php echo $fetch['adminpass']?>" placeholder="Password" value="" required="">
                                    </div>
                                </div>

                                  <div class="col-sm-6">
                                    <div class="form-group">
                                        <label class="floating-label" for="Text">Manager Phone</label>
                                        <input type="text" class="form-control"  name="phonenum" id="Text" value="<?php echo $fetch['adminphone']?>" placeholder="Manager Phone" required="">
                                    </div>
                                </div>
                             
                            </div>
                             <button type="submit" name="updateaccount" class="btn  btn-primary">Save Changes </button>
                        </form>
                    </div>
                </div>
            </div>
