                        ...
                        <h5>Update Exists Car</h5>
                                 ...
                                 <?php
                                     ...
                                     $fetch = $query->fetch_array();
                                      ?>
                                         <p class="error abonementexst-error" style="color: red;">
                                    <!-- error message -->
                     ...
                     <input type="hidden" name="cargoId" value="<?php echo $fetch['cargoid']?>"class="form-control" />
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="drivernames" id="Text" placeholder="Driver Names" value="<?php echo $fetch['drivernames']?>" required="">
                                    </div>
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="cartypes"  value="<?php echo $fetch['cartype']?>" id="Text" placeholder="Car Type" required="">
                                    </div>
                                </div>
                             ...
                             <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="carplat" value="<?php echo $fetch['carplate']?>" id="Email" placeholder="Car Plate" value="" required="">
                                    </div>
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <label class="floating-label" for="Email">Car Status</label>
                                         <select class="form-control" name="carstatuss" required="">
			                               <option></option>
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="driverphon"  value="<?php echo $fetch['driverphone']?>" id="Text" placeholder="Driver Phone" value="" required="">
                                    </div>
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="driverothephon" value="<?php echo $fetch['driverotherphone']?>" id="password" placeholder="Driver Other Phone" required="">
                                    </div>
                             ...
                             <button type="submit" name="savecargo" class="btn  btn-primary">Save Changes </button>
                        </form>
                    </div>
                </div>
            </div>
