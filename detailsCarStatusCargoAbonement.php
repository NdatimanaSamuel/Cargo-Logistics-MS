...
<section class="pcoded-main-container">
                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <div class="page-header-title">
                            <h5 class="m-b-10">Cargo</h5>
                        </div>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="index.html"><i class="feather icon-home"></i></a></li>
                            <li class="breadcrumb-item"><a href="#!">Car Cargo Status Details </a></li>
  ...
  <!--           <div class="col-md-6">
        ...
        <div class="col-xl-12">
            ...
            <div class="card mb-3">
              ...
              <div class="card-body">
                      <?php
                                     ...
                                     $query = $conn->query("SELECT * FROM `abonement` WHERE `abonementid` ='$ID'") or die(mysqli_error());
                                     ...
                                     $querys = $conn->query("SELECT * FROM `cargotb` WHERE `cargoid` ='$carID'") or die(mysqli_error());
               ...
               <table>
                <tr>
               <strong ><td><b>Car Code:</b></td><td><?php echo $fetchs['carcode']?></td></strong>
                   
                       <td><b> <h3>Abonement Information</h3></b></strong></td><br>
                   

                </tr>
                <tr>
                   <strong ><td><b>Car Type:</b></td><td><?php echo $fetchs['cartype']?></td></strong>

                     <td><b>Driver Name:</b></td><td><?php echo $fetch['drivername']?></td></strong>
                </tr>	
                <tr>
               <strong ><td><b>Car Plate:</b></td><td><?php echo $fetchs['carplate']?></td></strong>

                <strong ><td><b>Driver Phone : </b></td><td><?php echo $fetch['driverphone']?>/<?php echo $fetch['driverotherphon']?> </td>
               
                </tr>
                  <tr>
                 <strong ><td><b>Driver Name:</b></td><td><?php echo $fetchs['drivernames']?></td></strong>
                   <strong ><td><b>Cargo Price:</b></td><td><?php echo $fetch['cargoprice']?></td></strong>

                </tr>	
                <tr>
                 <strong ><td><b>Driver Phone : </b></td><td><?php echo $fetchs['driverphone']?> </td>

                 	 <strong ><td><b>Abonement Day : </b></td><td><?php echo $fetch['abonementday']?> </td>
                </tr>
               
                <tr>
                <strong ><td><b>Driver Other Phone: </b></td><td><?php echo $fetchs['driverotherphone']?></td></strong>

                <strong ><td><b>Abonement Remain Day : </b></td><td><?php echo $fetch['remainday']?> </td>
                    
                </tr>

                  <tr>
                      <strong ><td><b>Done On: </b></td><td><?php echo $fetchs['doneon']?></td></strong>

                      <strong ><td><b>Toatal Paid : </b></td><td><?php echo $fetch['totalpay']?> Frw </td>
                </tr>	

                <tr>
                      <strong ><td><b>Taken On: </b></td><td><?php echo $fetch['doneon']?></td></strong>

                    <td><b>Cargo Name:</b></td><td><?php echo $fetch['cargoname']?></td></strong>
                </tr>	
				...
				<center>
					<div class="qrframe" style="border:2px solid black; width:210px; height:210px;">
							...
							<form method="post"   >
								...
								<input type="hidden" name="msg" value="<?php echo $fetchs['carplate']?>" />

					<input type="submit" name="submit" value="Generate" class="btn btn-success submitBtn" style="margin-left:180px;margin-top: 14px; "/>
					</form>
					</div>
					<a class="btn btn-primary submitBtn" style="width:170px; margin:5px 0;" href="download.php?file=<?php echo $filename; ?>.png ">Download QR Code</a> 
            ...
            <div class="col-xl-12"  style="width: 1090px;">
                <div class="card">
                    <div class="card-header">
                        <h5>View All Car Cargo</h5>
                        <!-- <span class="d-block m-t-5">use class <code>table-striped</code> inside table element</span> -->
                         <div class="float-right">
                      <form>
                        <div >
                          <input type="search" id="myInput" onkeyup="myFunction()"  placeholder="Search By Date" class="form-control" style="width: 210px;" />
                    ...
                    <div class="card-body table-border-style">
                        <div class="table-responsive">
                         ...
                         $conn=mysqli_connect("localhost","root","", "cargologisticdb") or die(mysql_error());
                          $no=0;
                         $query = $conn->query("SELECT * FROM `attendencetb` where  cargoid='$carID'  ORDER BY attendenceid DESC") or die(mysqli_error());
                        while($fetch = $query->fetch_array()){
                         ...
                         ?> 
                                <tbody>
                                    <tr>
                                       <td><?php echo $no ;?></td>
                                       <td><?php echo $fetchs['carplate']?></td>
                                        <td><?php echo $fetch['attendedtime']?></td>
                                        <td><?php echo $fetch['attendeddate']?></td>
