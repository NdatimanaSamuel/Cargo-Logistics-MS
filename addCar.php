                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="#!">Add Car</a></li>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <input type="hidden" class="form-control" value="<?php echo$Random_code;?>" name="cargcode" required>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label class="floating-label" for="Text">Driver Names</label>
                                        <input type="text" class="form-control" name="drivernames" id="Text" placeholder="Driver Names" value="<?php echo $driverNames?>"required="">
                                    </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="cartypes"  value="<?php echo $carTypes?>" id="Text" placeholder="Car Type" required="">
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="carplat"  value="<?php echo $carPlat?>" id="Email" placeholder="Car Plate" value="" required="">
                                    </div>
                                       <p class="error carexist-error" style="color: red;">
                                    <!-- error message -->
				                    <?php echo $CarExistsexist_error;?>
				                  </p>
                                </div>
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <label class="floating-label" for="Text">Driver Phone</label>
                                        <input type="text" class="form-control" name="driverphon"  value="<?php echo $driverPhone?>" id="Text" placeholder="Driver Phone" value="" required="">
                                    </div>
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="driverothephon"  value="<?php echo $driverOthePhone?>" id="password" placeholder="Driver Other Phone" required="">
                                    </div>
                             ...
                             <button type="submit" name="savecargo" class="btn  btn-primary">Submit</button>
                        </form>
                    </div>
                </div>
            </div>
