                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="from_date" value="<?php if(isset($_GET['from_date'])){ echo $_GET['from_date']; } ?>" class="form-control"  style="width:150px;">
                                    </div>
                                </div>
                    ...
                    <div class="card-body table-border-style">
                        <div class="table-responsive">
                           ...
                           <?php 
                                ...
                                if(isset($_GET['from_date']))
                                {
                                    ...
                                    $query = "SELECT * FROM abonement WHERE remainday>=1 AND doneon='$from_Date' ";
                     ...
                     <?php
                         ...
                         $conn=mysqli_connect("localhost","root","", "cargologisticdb") or die(mysql_error());
                          ...
                          $querytotal = $conn->query(" SELECT sum(totalpay) from abonement WHERE remainday>=1 AND doneon='$from_Date' ") or die(mysqli_error());
