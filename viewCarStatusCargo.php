            ...
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-header">
                      ...
                      <form>
                        <div >
                          <input type="search" id="myInput" onkeyup="myFunction()"  placeholder="Search Driver Name" class="form-control" style="width: 210px;" />
                    ...
                    <div class="card-body table-border-style">
                        <div class="table-responsive">
                         ...
                         $conn=mysqli_connect("localhost","root","", "cargologisticdb") or die(mysql_error());
                          $no=0;
                         $query = $conn->query("SELECT * FROM `carcargotb` ORDER BY carcargoid DESC") or die(mysqli_error());
                        while($fetch = $query->fetch_array()){
                         ...
                         <a title="Details Car Cargo" href="detailsCarStatusCargo.php?id=<?php echo $fetch['carcargoid']?>"  class="btn btn-success btn-sm btn-icon-text mr-3">  Details  <i class="typcn typcn-edit btn-icon-append"></i></a>
