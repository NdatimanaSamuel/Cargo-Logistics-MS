<?php  
session_start();  
require ("updateCarTypeQuery.php");
                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <div class="page-header-title">
                            <h5 class="m-b-10">Form Car Type</h5>
                        </div>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="homeManager.php"><i class="feather icon-home"></i></a></li>
                            <li class="breadcrumb-item"><a href="#!">Update Car Type</a></li>
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h5>Update  Exist Car Type</h5>
                                    ...
                                    <?php
                                     ...
                                     $query = $conn->query("SELECT * FROM `cartypetb` WHERE `cartypeid` ='$ID'") or die(mysqli_error());
                    ...
                    <div class="card-body">
                        <form method="POST">
                            <div class="row">
                            	   <input type="hidden" name="cartypeIds" value="<?php echo $fetch['cartypeid']?>"class="form-control" />
                           
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label class="floating-label" for="Text">Car Type</label>
                                        <input type="text" class="form-control" name="cartype" value="<?php echo $fetch['cartype']?>" id="Text" placeholder="Car Type" required="">
                                    </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label class="floating-label" for="Email">Car Price</label>
                                        <input type="text" class="form-control" name="carprices"  value="<?php echo $fetch['carprice']?>" id="Email" placeholder="Car Plate" value="" required="">
                                    </div>
                             ...
                             <button type="submit" name="savecartype" class="btn  btn-primary">Save Changes</button>
                        </form>
                    </div>
                </div>
            </div>
