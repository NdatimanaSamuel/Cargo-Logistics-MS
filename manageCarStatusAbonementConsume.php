  ...
  <!--           <div class="col-md-6">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <!-- <input type="text" name="text" id="myInput" readonyy="" placeholder="scan qrcode" class="form-control"> -->
                </div>
            </div>
        </div>
                         <div class="float-right">
                      <form>
                        <div >
                          <input type="text" id="myInput" onkeyup="myFunction()"  placeholder="Search By Plate Number" class="form-control" style="width: 210px;" />
                    ...
                    <div class="card-body table-border-style">
                        <div class="table-responsive">
                         ...
                         $conn=mysqli_connect("localhost","root","", "cargologisticdb") or die(mysql_error());
                          $no=0;
                         $query = $conn->query("SELECT * FROM `cargotb` WHERE `cargostatususe` = 'abonement' ORDER BY cargoid DESC") or die(mysqli_error());
                        while($fetch = $query->fetch_array()){
                         ...
                         ?> 
  						...
  						<a title="Manage Car Details"  href="manageCarCargoAbonementConsume.php?id=<?php echo $fetch['cargoid']?>" class="btn btn-success btn-sm btn-icon-text">  Manage Consume   <i class="typcn typcn-eye-outline btn-icon-append"></i> </a>
