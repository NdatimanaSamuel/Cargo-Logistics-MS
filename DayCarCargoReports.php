                    ...
                    <div class="card-body table-border-style">
                        <div class="table-responsive">
                           ...
                           <?php 
                                ...
                                if(isset($_GET['from_date']))
                                {
                                    ...
                                    $query = "SELECT * FROM carcargotb WHERE doneon='$from_Date' ";
                     ...
                     <?php
                         ...
                         $conn=mysqli_connect("localhost","root","", "cargologisticdb") or die(mysql_error());
                          ...
                          $querytotal = $conn->query(" SELECT sum(cargoprice)FROM carcargotb WHERE doneon='$from_Date' ") or die(mysqli_error());
