                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="#!">Add Car Type</a></li>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="cartype"  value="<?php echo $carType?>" id="Text" placeholder="Car Type" required="">
                                    </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="carprices"  value="<?php echo $carPrices?>" id="Email" placeholder="Car Plate" value="" required="">
                                    </div>
                             ...
                             <button type="submit" name="savecartype" class="btn  btn-primary">Submit</button>
                        </form>
                    </div>
                </div>
            </div>
