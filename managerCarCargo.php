                ...
                <div class="card">
                    ...
                    <div class="card-body">
                     ...
                     <input type="hidden" name="cargoId" value="<?php echo $fetch['cargoid']?>"class="form-control" />
                            ...
                            $sqlQuery  = "select distinct cartype from cartypetb";
                  ...
                  <option value="<?php echo $row['carprice']; ?>" ><?php echo $row['cartype']; ?> </option>
                              <?php
                                ...
                                ?>
                                   ...
                                   <div class="col-sm-4">
                                    <div class="form-group">
                                        <label class="floating-label" for="password">Status</label>
                                       <select class="form-control" name="cargostatus" required="">
			                               <option></option>
			                              <option>In</option>
			                              <option>Out</option>
			                            </select>
                             ...
                             <button type="submit" name="savecargos" class="btn  btn-primary">Save Changes </button>
                        </form>
                    </div>
                </div>
            </div>
