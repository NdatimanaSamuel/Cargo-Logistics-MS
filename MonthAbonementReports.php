                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="#!">Filter Day Reports </a></li>
  ...
  <!--           <div class="col-md-6">
            ...
            <!-- [ stiped-table ] start -->
             <div class="col-xl-12">
                <div class="card">
                    <div class="card-header">
                        <h5>View Day Abonement Reports</h5>
                   ...
                   <div class="card-header">
                    <div class="float-left">
                      <form method="GET">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <label class="floating-label" for="Text">From Date</label>
                                        <input type="date" class="form-control" name="from_date" value="<?php if(isset($_GET['from_date'])){ echo $_GET['from_date']; } ?>" id="Text" required="">
                                    </div>
                                    
                                </div>
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <label class="floating-label" for="Text">To Date</label>
                                        <input type="date" class="form-control" name="to_date" value="<?php if(isset($_GET['to_date'])){ echo $_GET['to_date']; } ?>"   required="">
                                    </div>
                                </div>
                     ...
                     <button type="button" value="click" onclick="printDiv()" class="btn btn-primary"  style="margin-top: 28px; margin-left: 10px;">
                      Print
                    </button>
            ...
            <div class="col-xl-12" id="GFG">
                <div class="card">
                    <div class="card-header">
                        <h5>View Day Abonement</h5>
                        <!-- <span class="d-block m-t-5">use class <code>table-striped</code> inside table element</span> -->
                         <div class="float-right">
                      <form>
                        <div >
                          <input type="search" id="myInput" onkeyup="myFunction()"  placeholder="Search  Names " class="form-control" style="width: 210px;" />
                    ...
                    <div class="card-body table-border-style">
                        <div class="table-responsive">
                           ...
                           <?php 
                                $con = mysqli_connect("localhost","root","","cargologisticdb");
                                 $no=0;
                                 $count=0;
                                ...
                                if(isset($_GET['from_date']))
                                {
                                    ...
                                    $query = "SELECT * FROM abonement WHERE remainday>=1 AND doneon BETWEEN '$from_date' AND '$to_date' ";
                                    ...
                                    <tr>
                                       ...
                                       <td><?php echo $row['cargoname']?></td>
                                        ...
                                        <td><?php echo $row['driverphone']?></td>
                                           ...
                                           <td><?php echo $row['cargoprice']?> Frw</td>
                                            <td><?php echo $row['abonementday']?> Days</td>
                                             <td><?php echo $row['remainday']?> Days</td> 
                                             <td><?php echo $row['totalpay']?> Frw</td>
                                             <td><?php echo $row['doneon']?></td>
                                                <td>
  	

                         <a title="Details Car Cargo" href="detailsCarStatusCargoAbonement.php?id=<?php echo $row['abonementid']?>"  class="btn btn-success btn-sm btn-icon-text mr-3">  Details  <i class="typcn typcn-edit btn-icon-append"></i></a>
                       ...
                       <?php
                         ...
                         $conn=mysqli_connect("localhost","root","", "cargologisticdb") or die(mysql_error());
                          ...
                          $querytotal = $conn->query(" SELECT sum(totalpay) from abonement WHERE remainday>=1 AND doneon BETWEEN '$from_date' AND '$to_date' ") or die(mysqli_error());

 
                        while($fetchtotal = $querytotal->fetch_array()){
                          ?>


 <div class="card-footer small text-muted"><h2> <?php echo $fetchtotal ['sum(totalpay)']; }?> Frw</h2> Abonement Total Money To: <?php echo  $from_date ;?>  <?php echo  $to_date ;?></div>
                     Total Cargo :<?php echo $count; ?>
