...
<section class="pcoded-main-container">
                ...
                <div class="card">
                   ...
                   <div class="card-header">
                    <div class="float-left">
                     ...
                     <button type="button" value="click" onclick="printDiv()" class="btn btn-primary"  style="margin-top: 28px; margin-left: 20px;">
                      Print
                    </button>
                    ...
                    <div class="card-body table-border-style">
                        <div class="table-responsive">
                           ...
                           <?php 
                                ...
                                if(isset($_GET['from_date']))
                                {
                                    ...
                                    $query = "SELECT * FROM carcargotb WHERE doneon BETWEEN '$from_date' AND '$to_date' ";
                                       ...
                                       <td><?php echo $row['cargoname']?></td>
                                        ...
                                        <td><?php echo $row['driverphone']?></td>
                                           ...
                                           <td><?php echo $row['cargoprice']?> Frw</td>
                                            <td><?php echo $row['cargostat']?></td>
                                             <td><?php echo $row['geton']?></td> 
                                             <td><?php echo $row['gettime']?></td>
                                          
                                                <td>
  	

                         <a title="Details Car Cargo" href="detailsCarStatusCargo.php?id=<?php echo $row['carcargoid']?>"  class="btn btn-success btn-sm btn-icon-text mr-3">  Details  <i class="typcn typcn-edit btn-icon-append"></i></a>
                     ...
                     <?php
                         ...
                         $conn=mysqli_connect("localhost","root","", "cargologisticdb") or die(mysql_error());
                          ...
                          $querytotal = $conn->query(" SELECT sum(cargoprice)FROM carcargotb WHERE  doneon BETWEEN '$from_date' AND '$to_date' ") or die(mysqli_error());
 ...
 <div class="card-footer small text-muted"><h2> <?php echo $fetchtotal ['sum(cargoprice)']; }?> Frw</h2> Abonement Total Money To: <?php echo  $from_date ;?>  <?php echo  $to_date ;?></div>
