<?php  
session_start();  
require ("addCarCargoAbonementQuery.php");
                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <div class="page-header-title">
                            <h5 class="m-b-10">Form Cargo Abonement</h5>
                        </div>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="homeManager.php"><i class="feather icon-home"></i></a></li>
                            <li class="breadcrumb-item"><a href="#!">Cargo Details</a></li>
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h5>Manage Cargo Abonement</h5>
                                 ...
                                 <?php
                                     ...
                                     $query = $conn->query("SELECT * FROM `cargotb` WHERE `cargoid` ='$ID'") or die(mysqli_error());
                                     $fetch = $query->fetch_array();
                                      ?>

                                         <p class="error existabonement-error" style="color: red;">
                                    <!-- error message -->
                    ...
                    <div class="card-body">
                     ...
                     <input type="hidden" name="cargoId" value="<?php echo $fetch['cargoid']?>"class="form-control" />
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <label class="floating-label" for="Text">Driver Names</label>
                                        <input type="text" class="form-control" name="drivernames" id="Text" placeholder="Driver Names"value="<?php echo $fetch['drivernames']?>" readonly="">
                                    </div>
                                    
                                </div>
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <label class="floating-label" for="Text">Car Type</label>
                                        <input type="text" class="form-control" name="cartypes"  value="<?php echo $fetch['cartype']?>" id="Text" placeholder="Car Type" readonly="">
                                    </div>
                                </div>

                                  <div class="col-sm-4">
                                    <div class="form-group">
                                        <label class="floating-label" for="Text">Car Code</label>
                                        <input type="text" class="form-control" name="cartypes"  value="<?php echo $fetch['carcode']?>" id="Text" placeholder="Car Type" readonly="">
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <label class="floating-label" for="Email">Car Plate</label>
                                        <input type="text" class="form-control" name="carplat" value="<?php echo $fetch['carplate']?>" id="Email" placeholder="Car Plate"  readonly="">
                                    </div>
                                   
                                </div>
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <label class="floating-label" for="Text">Driver Phone</label>
                                        <input type="text" class="form-control" name="driverphon"  value="<?php echo $fetch['driverphone']?>" id="Text" placeholder="Driver Phone" readonly="">
                                    </div>
                                   
                                </div>
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <label class="floating-label" for="password">Driver Other Phone</label>
                                        <input type="text" class="form-control" name="driverothephon" value="<?php echo $fetch['driverotherphone']?>" id="password" placeholder="Driver Other Phone" readonly="">
                                    </div>
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <label class="floating-label" for="Email">Cargo Name</label>
                                        <input type="text" class="form-control" name="cargonames" value="<?php echo $cargoNames?>" id="Email" placeholder="Cargo Name" required ="">
                                    </div>
                                   
                                </div>
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <label class="floating-label" for="Text">Driver Name</label>
                                        <input type="text" class="form-control" name="drivernames" value="<?php echo $driverNames?>"  value="" id="Text" placeholder="Driver Name"  required="">
                                    </div>
                                  <p class="error Drivername-error" style="color: red;">
                                    <!-- error message -->
				                    <?php echo $drivernames_error;?>
				                  </p>
                                </div>
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <label class="floating-label" for="password">Driver Phone</label>
                                        <input type="text" class="form-control" name="driverphone" value="<?php echo $driverPhone?>"id="password" placeholder="Driver Phone"  required ="">
                                    </div>
                                     <p class="error phonerr-error" style="color: red;">
                                    <!-- error message -->
				                    <?php echo $phoneuser_error;?>
				                  </p>

				                   <p class="error phonefewrr-error" style="color: red;">
                                    <!-- error message -->
				                    <?php echo $userfewphonelenght_error;?>
				                  </p>
                                </div>
                                 <div class="col-sm-4">
                                    <div class="form-group">
                                        <label class="floating-label" for="password">Driver Other Phone</label>
                                        <input type="text" class="form-control" name="driverotherphone" value="<?php echo $driverPhone?>"  id="password" placeholder="Driver Other Phone" required="">
                                    </div>
                                           <p class="error phonothererr-error" style="color: red;">
                                    <!-- error message -->
				                    <?php echo $phoneOtheruser_error;?>
				                  </p>

				                  <p class="error phoneotherfewrr-error" style="color: red;">
                                    <!-- error message -->
				                    <?php echo $userfewphonelenght_error;?>
				                  </p>
                                </div>
                                 ...
                                 <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="cargofees" required="">
			                                  <option></option>
                             <?php
                              $conn = mysqli_connect("localhost","root","","cargologisticdb");

                            $sqlQuery  = "select distinct cartype,carprice from cartypetb";
                         $myData  = mysqli_query($conn , $sqlQuery);
                        while ($row = mysqli_fetch_array($myData)) {
                         ?>
                  <option value="<?php echo $row['carprice']; ?>" ><?php echo $row['cartype']; ?> </option>
                              <?php
                                 }
                                ?>
			                            </select>
                                   ...
                                   <div class="col-sm-4">
                                    <div class="form-group">
                                        <label class="floating-label" for="password">Abonement Day</label>
                                       <input type="text" class="form-control" name="abonementday" value="<?php echo $driverPhone?>"  id="password" placeholder="Abonement Day" required="">
                                    </div>

                                     <p class="error valdday-error" style="color: red;">
                                    <!-- error message -->
				                    <?php echo $validday_error;?>
				                  </p>
                             ...
                             <button type="submit" name="savecargosabonement" class="btn  btn-primary">Save Changes </button>
                        </form>
                    </div>
                </div>
            </div>
