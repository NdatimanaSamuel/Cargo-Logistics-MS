            ...
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-header">
                      ...
                      <form>
                        <div >
                          <input type="search" id="myInput" onkeyup="myFunction()"  placeholder="Search Car by Name" class="form-control" style="width: 210px;" />
                    ...
                    <div class="card-body table-border-style">
                        <div class="table-responsive">
                         ...
                         $conn=mysqli_connect("localhost","root","", "cargologisticdb") or die(mysql_error());
                          $no=0;
                         $query = $conn->query("SELECT * FROM `cartypetb` ORDER BY 	cartypeid DESC") or die(mysqli_error());
                                ...
                                <tbody>
                                    <tr>
                                       ...
                                       <td><?php echo $fetch['cartype']?></td>
                                        <td><?php echo $fetch['carprice']?></td>
                                        <td><?php echo $fetch['doneon']?></td>
                                         
                                                <td>
  						
  						  <a title="Delete Car Type" onclick="return confirm('are you sure you want to delete')" href="deleteCarType.php?id=<?php echo $fetch['cartypeid']?>" class="btn btn-danger btn-sm btn-icon-text">  Delete  <i class="typcn typcn-delete-outline btn-icon-append"></i> </a>

                         <a title="Edit Car Type" href="updateCarType.php?id=<?php echo $fetch['cartypeid']?>"  class="btn btn-success btn-sm btn-icon-text mr-3">  Edit  <i class="typcn typcn-edit btn-icon-append"></i></a>
