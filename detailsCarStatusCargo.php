            ...
            <div class="card mb-3">
              ...
              <div class="card-body">
                      <?php
                                     ...
                                     $query = $conn->query("SELECT * FROM `carcargotb` WHERE `carcargoid` ='$ID'") or die(mysqli_error());
                ...
                <div class="card">
                    ...
                    <div class="card-body table-border-style">
                        <div class="table-responsive">
                         ...
                         $conn=mysqli_connect("localhost","root","", "cargologisticdb") or die(mysql_error());
                          $no=0;
                         $query = $conn->query("SELECT * FROM `carcargotb` where  cargoid='$carID'  ORDER BY carcargoid DESC") or die(mysqli_error());
                        while($fetch = $query->fetch_array()){
                         ...
                         ?> 
                                <tbody>
                                    <tr>
                                       <td><?php echo $no ;?></td>
                                       <td><?php echo $fetch['cargoname']?></td>
                                        <td><?php echo $fetch['drivername']?></td>
                                        <td><?php echo $fetch['driverphone']?></td>
                                          <td><?php echo $fetch['driverotherphon']?></td>
                                          <td><?php echo $fetch['cargoprice']?> Frw</td>
                                          	
                                           <td><?php echo $fetch['cargostat']?></td>
                                            <td><?php echo $fetch['geton']?></td>
                                             <td><?php echo $fetch['gettime']?></td>
