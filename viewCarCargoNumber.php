                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="#!">All Car Cargo</a></li>
                ...
                <div class="card">
                   ...
                   <div class="card-header">
                    <div class="float-left">
                      ...
                      <label for="password2" class="d-block"><!-- Status --></label>
                         <button type="submit" name="showdata" class="btn btn-primary btn-block" style="margin-top: 28px; width: 100px;">
                      Show
                    </button> 
                    </div>
                  </div>
                   ...
                   <button type="button" value="click" onclick="printDiv()" class="btn btn-primary"  style="margin-top: 28px; margin-left: 60px;">
                      Print
                    </button>
                  </div>
                </div>
                    ...
                    <div class="card-body table-border-style">
                        <div class="table-responsive">
                           ...
                           <?php 
                                ...
                                {
                                    $cargoStatus = $_GET['cargostatus'];
                                 
                                      $t=date("Y-m-d");
                                    // $to_date = $_GET['to_date'];

                                    $query = "SELECT * FROM carcargotb WHERE cargostat='$cargoStatus' AND doneon='$t' ";
                                    ...
                                    <tr>
                                       ...
                                       <td><?php echo $row['cargoname']?></td>
                                        ...
                                        <td><?php echo $row['driverphone']?></td>
                                          <td><?php echo $row['driverotherphon']?></td>
